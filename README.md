...
GridRadar kaynağı için kullanılan metrik `frequency-ucte-median-1s` değeridir. Kaynak 1 saniye kaynak çözünürlüğü ile gelir, sayfada yaklaşık 15 dakika gecikme bilgisiyle sunulur ve son 24 saatlik görünüm 60 saniyelik özet seri üzerinden çizilir. Ana grafik ham 1 saniyelik 24 saatlik veri indirme yüzeyi değildir; son 1 saat görünümü Worker'ın en fazla 1 saatle sınırlı `resolution=1s` sorgusundan, son 6 saat ve son 24 saat görünümleri normalde 60 saniyelik özet tampondan beslenir. 6/24 saat grafiğinde görünür pencere 15 dakika veya altına yakınlaştırıldığında yalnızca ilgili dar aralık için 1 saniyelik seri alınır ve aynı aralık tekrar sorgulanırsa ön yüz cache'i kullanılır.
