...
assert.match(html, /rocofMethodCentral:\s*['"]Merkezî fark — çevrimdışı['"]/, "Turkish central method label should be precise.");
assert.match(html, /rocofMethodFiltered:\s*['"]Hareketli ortalama filtreli merkezî fark['"]/, "Turkish filtered method label should be precise.");
assert.match(html, /rocofMethodRegression:\s*['"]Kayan pencereli doğrusal regresyon['"]/, "Turkish regression method label should be precise.");
...
assert.match(html, /rocofMethodCentral:\s*['"]Centered difference — offline['"]/, "English central method label should be precise.");
assert.match(html, /rocofMethodFiltered:\s*['"]Moving-average filtered centered difference['"]/, "English filtered method label should be precise.");
assert.match(html, /rocofMethodRegression:\s*['"]Sliding-window linear regression['"]/, "English regression method label should be precise.");
